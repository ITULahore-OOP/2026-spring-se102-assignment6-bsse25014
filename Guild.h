...
// calculateTotalGuildPower() int

// displayGuildStats() void

// operator<(ostream, Guild) ostream
...
// getSpellPower() const int

// Warrior

// int armorRating
// Warrior(string, int, int, int, int)

// getArmor() int

// calculateEffectiveHealth() int
...
// calculateBurstDamage() int

// Spellblade

// Spellblade(string, int, int, int, int, int)
// calculateHybridDamage() int